...
# Chay: PowerShell -ExecutionPolicy Bypass -File k8s\start-cluster.ps1
...
Write-Host ""
Write-Host "Prometheus : kubectl port-forward svc/kube-prom-kube-prometheus-prometheus 9090:9090 -n monitoring"
